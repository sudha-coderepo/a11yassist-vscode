...
class ARIAValidator {
     ...
     */
    validateBooleanValue(attribute, value, allowedValues) {
     ...
     */
    validateTristateValue(attribute, value) {
     ...
     */
    validateTokenValue(attribute, value, allowedValues) {
     ...
     */
    validateTokenListValue(attribute, value) {
     ...
     */
    validateIntegerValue(attribute, value) {
     ...
     */
    validateStringValue(attribute, value) {
     ...
     */
    needsAccessibleName(tagName, role) {
     ...
     */
    extractARIAAttributes(elementString) {
        const ariaAttrs = {};
     ...
     */
    getRecommendedAttributes(tagName, role) {
...
exports.ARIAValidator = ARIAValidator;
/**
 * Valid ARIA roles according to WAI-ARIA 1.2
 */
ARIAValidator.VALID_ROLES = [
 ...
 */
ARIAValidator.INTERACTIVE_ELEMENTS = [
    'a', 'button', 'input', 'select', 'textarea', 'summary'
];
//# sourceMappingURL=ariaValidator.js.map