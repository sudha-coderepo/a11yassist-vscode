...
class KeyboardNavigationManager {
    ...
    registerCustomShortcuts() {
        ...
        this.context.subscriptions.push(vscode.commands.registerCommand('a11yassist.quickNavigation', () => {
            this.showQuickNavigationMenu();
        }));
        // Register jump to section command
        this.context.subscriptions.push(vscode.commands.registerCommand('a11yassist.jumpToSection', () => {
            this.jumpToSection();
        }));
        // Register focus management command
        this.context.subscriptions.push(vscode.commands.registerCommand('a11yassist.manageFocus', () => {
            this.manageFocus();
        }));
    }
    /**
     ...
     */
    showKeyboardGuide() {
        const panel = vscode.window.createWebviewPanel('keyboardGuide', 'Keyboard Navigation Guide', vscode.ViewColumn.One, {
            enableScripts: true
        });
