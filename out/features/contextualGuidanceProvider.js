...
class ContextualGuidanceProvider {
    ...
    loadConfiguration() {
        ...
        return {
            ...
            verbosityLevel: config.get('verbosityLevel', 'normal'),
     ...
     */
    detectContext(lineText, languageId) {
    ...
    showGuidanceNotification(guidance) {
        vscode.window.showInformationMessage(`Accessibility Tip: ${guidance.title}`, 'Show Details', 'Dismiss').then(selection => {
     ...
     */
    showGuidancePanel(guidance) {
        const panel = vscode.window.createWebviewPanel('accessibilityGuidance', guidance.title, vscode.ViewColumn.Beside, {
            enableScripts: false
        });
...
exports.ContextualGuidanceProvider = ContextualGuidanceProvider;
//# sourceMappingURL=contextualGuidanceProvider.js.map