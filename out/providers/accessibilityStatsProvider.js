...
class AccessibilityStatsProvider {
    ...
    getSummaryItems() {
        ...
        const items = [];
        // Total audits run
        const auditsItem = new StatsTreeItem('Total Audits Run', vscode.TreeItemCollapsibleState.None);
        ...
        // Total issues found
        const issuesFoundItem = new StatsTreeItem('Issues Found', vscode.TreeItemCollapsibleState.None);
        ...
        // Total issues fixed
        const issuesFixedItem = new StatsTreeItem('Issues Fixed', vscode.TreeItemCollapsibleState.None);
        ...
        if (stats.totalIssuesFound > 0) {
            ...
            const fixRateItem = new StatsTreeItem('Fix Rate', vscode.TreeItemCollapsibleState.None);
        ...
        if (Object.keys(stats.featuresUsed).length > 0) {
            const featureUsageItem = new StatsTreeItem('Feature Usage', vscode.TreeItemCollapsibleState.Collapsed);
        ...
        // Last used
        const lastUsedItem = new StatsTreeItem('Last Used', vscode.TreeItemCollapsibleState.None);
        ...
        // Actions
        const viewDetailsItem = new StatsTreeItem('View Detailed Analytics', vscode.TreeItemCollapsibleState.None);
    ...
    getFeatureUsageItems() {
        ...
        return sortedFeatures.map(([featureName, count]) => {
            const item = new StatsTreeItem(this.formatFeatureName(featureName), vscode.TreeItemCollapsibleState.None);
...
exports.AccessibilityStatsProvider = AccessibilityStatsProvider;
/**
...
//# sourceMappingURL=accessibilityStatsProvider.js.map